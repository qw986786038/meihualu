...
class AppCameraFlashButton extends StatelessWidget {
  final CameraState state;
  final AwesomeTheme? theme;
  final Widget Function(FlashMode) iconBuilder;
  final void Function(SensorConfig, FlashMode) onFlashTap;

  AppCameraFlashButton({super.key, required this.state, this.theme, Widget Function(FlashMode)? iconBuilder, void Function(SensorConfig, FlashMode)? onFlashTap})
    : iconBuilder =
          iconBuilder ??
          ((flashMode) {
            final IconData icon;
        ...
        return StreamBuilder<FlashMode>(
          ...
          builder: (context, snapshot) {
            ...
            return AwesomeOrientedWidget(
              ...
              child: IconButton(icon: iconBuilder(snapshot.requireData), onPressed: () => onFlashTap(sensorConfig, snapshot.requireData)),
            );
          },
        );
      },
