...
class MediaMultiSelectController extends GetxController {
  ...
  List<AssetEntity> get visibleAssets {
    if (!onlyTodayWatermark.value) return assets;
  ...
  void toggleOnlyTodayWatermark(bool value) {
    onlyTodayWatermark.value = value;
  }
