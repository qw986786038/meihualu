...
class ImageTaggingPickerPage extends StatefulWidget {
  const ImageTaggingPickerPage({super.key});

  @override
  State<ImageTaggingPickerPage> createState() => _ImageTaggingPickerPageState();
}

class _ImageTaggingPickerPageState extends State<ImageTaggingPickerPage> {
  ...
  void _requestCapture() {
    if (_isRecognizing) return;
    context.pop(kImageTaggingCaptureAction);
  }
