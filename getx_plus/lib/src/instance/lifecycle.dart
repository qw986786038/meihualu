...
mixin GetLifeCycleMixin {
  ...
  @mustCallSuper
  void onInit() {
    // Guard against the controller being disposed before the next frame,
    // e.g. fast navigation, GetBinding rapid unmount, or unit tests.
...
typedef GetService = GetxService;

/// Marker mixin alias for [GetxServiceMixin].
typedef GetServiceMixin = GetxServiceMixin;
